...
const app = new App();
// Agregar plataformas
app.agregarPlataforma("Twitch", "twitch_logo.png", "Plataforma de streaming enfocada en videojuegos", "Amazon");
app.agregarPlataforma("YouTube Live", "youtube_logo.png", "Plataforma de streaming con contenido variado", "Google");
// Agregar canales
